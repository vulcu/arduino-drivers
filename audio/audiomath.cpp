...
#ifndef AUDIOMATH_GAIN_BOUND_VALUES
#define AUDIOMATH_GAIN_BOUND_VALUES
...
void Audiomath::dBFastRelativeLevel(uint16_t *dB_levels, const uint16_t base_level) {
...
void Audiomath::mapVolumeToBoundedRange(const uint8_t volume, uint8_t *volume_map, 
...
uint8_t Audiomath::getVolumeMapIndx(const uint16_t audio_level, const uint16_t *dB_levels, 
